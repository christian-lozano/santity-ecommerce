...
const Invoice = (props) => {
  ...
  const tablerows = order?.orderinfo.products.map((item) => {
    return <Invoiceproduct item={item} />
  })
            ...
            <div className="ship">
              ...
              <div>
                ...
                <span>
                  ...
                  {order?.shippinginfo.province}, {order?.shippinginfo.zip}{" "}
                </span>
                <span>{order?.shippinginfo.street}</span>
              </div>
            </div>
          ...
          <div className="lowersection">
            ...
            <div className="invoicepricetotal">
              <div>
                <span>Subtotal:</span>
                <span>
                  ${totalPrice(order?.orderinfo.products, allproducts, [], 0)}
                </span>
              </div>
              <div>
                <span>Coupons:</span>
              ...
              <div>
                <span>Total:</span>
                <span>${order?.ordercost.toFixed(0)}</span>
              </div>
            </div>
          </div>
        </div>
