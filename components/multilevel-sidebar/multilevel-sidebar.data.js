    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            title: "Sandalias",
            icon: <i className="fa fa-opera"></i>,
            url: "tienda?tipo=sandalia&genero=hombre",
          },
          // ,
          // {
          //   id: 9,
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            title: "Polos",
            icon: <i className="fa fa-opera"></i>,
            url: "tienda?search=&tipo=ropa&genero=hombre&category=polo",
          },
          ,
          {
            id: 3,
            title: "Poleras",
            icon: <i className="fa fa-opera"></i>,
            url: "tienda?search=&tipo=ropa&genero=hombre&category=polera",
          },
          // {
          //   id: 3,
          //   title: "Licras",
          ...
          // },
          {
            ...
            title: "Casacas",
            icon: <i className="fa fa-opera"></i>,
            url: "tienda?search=&tipo=ropa&genero=hombre&category=casaca",
          },
          {
            id: 3,
            title: "Pantalones",
            icon: <i className="fa fa-opera"></i>,
            url: "tienda?search=&tipo=ropa&genero=hombre&category=pantalon",
          },
          {
            id: 3,
            title: "Camisetas de Futbol",
            icon: <i className="fa fa-opera"></i>,
            url: "tienda?search=&tipo=ropa&genero=hombre&category=camiseta",
          },
          {
            id: 9,
            title: "Shorts",
          ...
          },
          {
            ...
            title: "Buzos",
            icon: <i className="fa fa-opera"></i>,
            url: "tienda?search=&tipo=ropa&genero=hombre&category=buzo",
          },
        ],
      },
      {
        ...
        children: [
          ...
          // },
          {
            ...
            title: "Mochilas",
            icon: <i className="fa fa-opera"></i>,
            url: "tienda?search=&tipo=ropa&genero=hombre&category=mochila",
          },
          // {
          //   id: 1,
          //   title: "Guantes",
          ...
          // },
          {
            ...
            title: "Gorras",
            icon: <i className="fa fa-opera"></i>,
            url: "tienda?search=&tipo=ropa&genero=hombre&category=gorra",
          },
          {
            id: 1,
            title: "Medias",
          ...
          },
          {
            ...
            title: "Bolsos",
            icon: <i className="fa fa-opera"></i>,
            url: "tienda?search=&tipo=ropa&genero=hombre&category=bolso",
          },
        ],
      },
    ],
